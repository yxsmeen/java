...
public class WarehouseTest {
	...
	public static void testAddItem() {
		...
		w.addItem(i);
		System.out.println("Number of items: " + w.getItems().size()); 
		System.out.println("");
	}
	...
	public static void testAddItem_Multiple() {
		...
		Item two = new Item("Milk", 3.246);
		Item three = new Item("Icecream", 3.246);
		w.addItem(one);
		w.addItem(two);
		w.addItem(three);
		System.out.println("Number of items: " + w.getItems().size()); 
	...
	public static void testAddItem_11_Items() {
		...
		Item b = new Item("Milk", 3.246);
		Item c = new Item("Icecream", 3.246);
		Item d = new Item("Orange", 3.246);
		Item e = new Item("Apple", 3.246);
		Item f = new Item("Coffee", 3.246);
		Item g = new Item("Egg", 3.246);
		Item h = new Item("Ham", 3.246);
		Item i = new Item("Mushroom", 3.246);
		Item j = new Item("Cheese", 3.246);
		Item k = new Item("Bread", 3.246);
		w.addItem(a);
		w.addItem(b);
		w.addItem(c);
		w.addItem(d);
	...
	public static void testGetItem_WithName() {
		...
		System.out.println("Item: " + w.getItem("Ice cream")); 
		System.out.println("");
	}
